...
try {
    ...
    // Setup html content
    $e_content = "<strong>$name_booking</strong> send a message with the following booking request:<br><br>Check in: $check_in<br>Check out: $check_out<br>Room Type: $room_type<br>Number of adults: $adults<br>Number of child: $children.<br><br>You can contact $name_booking via email: $email_booking.";
    ...
    $mail->Body = "Thank you we have received your booking request. Below a copy of your request:<br><br>" . $e_content . "";
